...
export function Header() {
    ...
    return (
        <>
            ...
            <section className={clsx("navbar-area navbar-nine", isScrolled && "scrolled")}>
                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <nav className="navbar navbar-expand-lg">
                                ...
                                <button
                                    className={clsx("navbar-toggler hidden", isNavbarOpen && "active")}
                                    type="button"
                                ...
                                <div className={clsx("collapse navbar-collapse sub-menu-bar", isNavbarOpen && "show")} id="navbarNine">
                                    <ul className="navbar-nav me-auto">
                                        <li className="nav-item">
                                            <a className="page-scroll active" href="#hero-area" onClick={() => setIsNavbarOpen(false)}>Home</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="page-scroll" href="#get-started" onClick={() => setIsNavbarOpen(false)}>Get Started</a>
                                        </li>
                                        <li className="nav-item">
                                            <a className="page-scroll" href="#services" onClick={() => setIsNavbarOpen(false)}>Services</a>
                                        </li>
                                    </ul>
                                </div>

                                <div className="navbar-btn d-none d-lg-inline-block hidden">
                                    <a className="menu-bar" href="#side-menu-left" onClick={(e) => { e.preventDefault(); toggleSidebar(); }}>
            ...
            <div className={clsx("sidebar-left", isSidebarOpen && "open")}>
                <div className="sidebar-close">
                    <a className="close" href="#close" onClick={(e) => { e.preventDefault(); closeSidebar(); }}>
                ...
                <div className="sidebar-content">
                    ...
                    <div className="sidebar-menu">
                        ...
                        <ul>
                            <li><a href="#how" className="nav-link" onClick={closeSidebar}>How it works</a></li>
                            <li><a href="#services" className="nav-link" onClick={closeSidebar}>Services</a></li>
                            <li><a href="#contact" className="nav-link" onClick={closeSidebar}>Contact Us</a></li>
                        </ul>
                    </div>
                    {/* menu */}
